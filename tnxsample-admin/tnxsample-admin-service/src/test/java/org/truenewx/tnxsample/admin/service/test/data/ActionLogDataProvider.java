...
public class ActionLogDataProvider extends AbstractDataProvider<ActionLog> {
    ...
    protected void init(DataPool pool) {
        ...
        log1.setAction(new Action(caption, "loginController", "isValid", Arrays.asList("username")));
        ...
        log2.setAction(new Action(caption, "loginController", "isValid", Arrays.asList("username")));
